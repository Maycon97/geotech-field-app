...
window.MDSYNC_GEOLOGIA_CAVA = {
  ...
  "camadasDisponiveis": [
    ...
    "Mapa",
    "Imagem_Ortofotos",
    "Mina_ES_Agosto2026.tif",
    "Geological_Maps",
    "Mapa_Geologia_0626",
    "Topografia",
    "tpes_260731",
    "Grade de Rótulo Horizontal Preta",
    "Rótulos",
    "tpes_260731 - Classe 1",
    "Seta Norte",
    "Barra de Escala",
    "Texto 1",
    "Figura",
    ...
    "AT",
    "cli",
    "samples_distance_maio2026",
    "Polyline Grupo",
    "[\"0_01_DESING_PLANO TRIMESTRAL_SUP_TRI_MOVEL_2026_LIMITES\",3,\"Continuous\"] 1",
    "Polyline"
  ],
  "viewportEsri": {
    "name": "Mapa",
